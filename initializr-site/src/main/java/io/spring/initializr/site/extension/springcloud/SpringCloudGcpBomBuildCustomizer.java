...
class SpringCloudGcpBomBuildCustomizer implements BuildCustomizer<Build> {
    ...
    public void customize(Build build) {
        if (isSpringBootVersionBefore() && description.getRequestedDependencies()
    ...
    private boolean isSpringBootVersionBefore() {
        return SpringCloudGcpBomBuildCustomizer.VERSION_2_1_0_M1.compareTo(description.getPlatformVersion()) > 0;
    }
