...
class SpringSessionBuildCustomizerTests extends AbstractExtensionTests {
    ...
    void sessionWithRedis() {
        ...
        request.setBootVersion("2.0.0.M3");
		generateMavenPom(request).hasSpringBootStarterDependency("data-redis")
                .hasSpringBootStarterTest().hasDependency(SpringSessionBuildCustomizerTests.REDIS).hasDependenciesCount(3);
    }
    ...
    void sessionWithJdbc() {
		...
		generateMavenPom(request).hasSpringBootStarterDependency("jdbc")
                .hasSpringBootStarterTest().hasDependency(SpringSessionBuildCustomizerTests.JDBC).hasDependenciesCount(3);
    }
    ...
    void sessionWithRedisAndJdbc() {
		...
		generateMavenPom(request).hasSpringBootStarterDependency("data-redis")
                .hasSpringBootStarterDependency("jdbc").hasSpringBootStarterTest()
                .hasDependency(SpringSessionBuildCustomizerTests.REDIS).hasDependency(SpringSessionBuildCustomizerTests.JDBC).hasDependenciesCount(5);
    }
