...
public class InitializrAutoConfiguration {
    ...
    @Bean
    public RestTemplateCustomizer restTemplateCustomizer(InitializrProperties initializrProperties) {
        return new ProxyCustomizer(initializrProperties);
    }

    @Bean
    @DependsOn(value = {"restTemplateCustomizer"})
    public RestTemplate restTemplate(InitializrProperties initializrProperties) {
        return new RestTemplateBuilder(restTemplateCustomizer(initializrProperties)).build();
    }

    @Bean
    @ConditionalOnMissingBean
    public InitializrMetadataUpdateStrategy initializrMetadataUpdateStrategy(RestTemplate restTemplate, ObjectMapper objectMapper) {
        return new DefaultInitializrMetadataUpdateStrategy(restTemplate, objectMapper);
    }
