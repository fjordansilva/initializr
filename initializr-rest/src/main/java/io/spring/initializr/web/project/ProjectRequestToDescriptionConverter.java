...
public class ProjectRequestToDescriptionConverter {
    ...
    public ProjectDescription convert(ProjectRequest request, InitializrMetadata metadata) {
        ...
        description.setDescription(determineValue(request.getDescription(), () -> metadata.getDescription().getContent()));
        description.setIrn(determineValue(request.getIrn(), () -> metadata.getIrn().getContent()));
        description.setSia(determineValue(request.getSia(), () -> metadata.getSia().getContent()));
