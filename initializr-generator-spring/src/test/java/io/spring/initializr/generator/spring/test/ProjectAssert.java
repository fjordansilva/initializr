...
public class ProjectAssert {
     ...
     *
     * @param name
     *         the expected name of the base directory
     *
    ...
    public ProjectAssert isJavaProject() {
        return isJavaProject(ProjectAssert.DEFAULT_PACKAGE_NAME, ProjectAssert.DEFAULT_APPLICATION_NAME);
    }
    ...
    public ProjectAssert isGroovyProject() {
        return isGroovyProject(ProjectAssert.DEFAULT_PACKAGE_NAME, ProjectAssert.DEFAULT_APPLICATION_NAME);
    }

    public ProjectAssert isKotlinProject() {
        return isKotlinProject(ProjectAssert.DEFAULT_PACKAGE_NAME, ProjectAssert.DEFAULT_APPLICATION_NAME);
    }
    ...
    public ProjectAssert isJavaWarProject(String expectedApplicationName) {
        return isGenericWarProject(ProjectAssert.DEFAULT_PACKAGE_NAME, expectedApplicationName, "java",
                "java");
    }

    public ProjectAssert isJavaWarProject() {
        return isJavaWarProject(ProjectAssert.DEFAULT_APPLICATION_NAME);
    }
