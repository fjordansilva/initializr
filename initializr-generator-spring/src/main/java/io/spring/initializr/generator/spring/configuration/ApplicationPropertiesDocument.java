 ...
 * @since 1.0.0
 */
public class ApplicationPropertiesDocument {

    private final MustacheTemplateRenderer templateRenderer;

    private final LinkedList<Section> sections = new LinkedList<>();

    public ApplicationPropertiesDocument(MustacheTemplateRenderer templateRenderer) {
        this.templateRenderer = templateRenderer;
    }

    public ApplicationPropertiesDocument addSection(Section section) {
     ...
     */
    public ApplicationPropertiesDocument addSection(String templateName, Map<String, Object> model) {
