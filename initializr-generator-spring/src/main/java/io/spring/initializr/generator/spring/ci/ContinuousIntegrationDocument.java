 ...
 * @since 1.0.0
 */
public class ContinuousIntegrationDocument {

    private final MustacheTemplateRenderer templateRenderer;

    private final LinkedList<Section> sections = new LinkedList<>();

    public ContinuousIntegrationDocument(MustacheTemplateRenderer templateRenderer) {
        this.templateRenderer = templateRenderer;
    }

    public ContinuousIntegrationDocument addSection(Section section) {
     ...
     */
    public ContinuousIntegrationDocument addSection(String templateName, Map<String, Object> model) {
