 ...
 * @since 1.0.0
 */
public class JenkinsDocumentCustomizer implements ContinuousIntegrationDocumentCustomizer {

    private final ResolvedProjectDescription projectDescription;

    private final InitializrMetadata metadata;

    public JenkinsDocumentCustomizer(ResolvedProjectDescription projectDescription, InitializrMetadata metadata) {
    ...
    public void customize(ContinuousIntegrationDocument document) {
        ...
        model.put("tab", "  ");
        document.addSection("ci/jenkinsfile", model);
    }
