...
public class ProjectGenerator {
     ...
     *
     * @param projectGenerationContext
     *         a consumer of the project generation context before
     *         it is refreshed.
     */
     ...
     *
     * @param description
     *         the description of the project to generate
     * @param projectAssetGenerator
     *         the {@link ProjectAssetGenerator} to invoke
     * @param <T>
    ...
    public <T> T generate(ProjectDescription description, ProjectAssetGenerator<T> projectAssetGenerator) throws ProjectGenerationException {
        try (ProjectGenerationContext context = new ProjectGenerationContext()) {
            ...
            projectGenerationContext.accept(context);
            context.refresh();
            try {
    ...
    static class ProjectGenerationImportSelector implements ImportSelector {
        ...
        public String[] selectImports(AnnotationMetadata importingClassMetadata) {
            List<String> factories = SpringFactoriesLoader.loadFactoryNames(ProjectGenerationConfiguration.class, getClass().getClassLoader());
